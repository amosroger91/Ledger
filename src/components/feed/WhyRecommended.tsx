...
export default function WhyRecommended({ reason, post, verdict, onBlock }: { reason?: RecommendationReason; post: Post; verdict?: ModerationVerdict; onBlock?: () => void }) {
        ...
        <Box sx={{ p: 2, width: 340, maxHeight: "80vh", overflowY: "auto" }}>
          ...
          <Stack spacing={1.25} sx={{ mt: 0.75 }}>
            ...
            {onBlock && !BOT(post.author) && post.author !== me && (
              <Button size="small" color="error" variant="outlined" startIcon={<BlockRoundedIcon />} onClick={() => { onBlock(); setAnchor(null); }}>
